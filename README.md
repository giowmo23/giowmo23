...
class AIArchitect:
    ...
    def __init__(self):
        ...
        self.alias = "Gio"
        self.role = "AI Architect | CTO & Co-Founder @ OptiPixel"
        self.location = "Guatemala 🇬🇹"
        self.years_in_telephony = 20
    ...
    def current_stack(self):
        return {
            ...
            "voice_pipeline": ["Pipecat", "faster-whisper", "Silero VAD",
                               "Kokoro TTS", "Chatterbox TTS"],
            "telephony": ["FusionPBX", "FreePBX", "SIP Trunks",
                          "DIDWW", "Claro", "Tigo"],
            "backend": ["Python", "Supabase", "n8n", "Railway",
...
<img src="https://skillicons.dev/icons?i=python,linux,bash,docker,supabase,cloudflare,vercel,githubactions,raspberrypi,postgres,nginx,git&perline=6" alt="Tech icons" />
...
[![Website](https://img.shields.io/badge/OptiPixel-sofiachat.com-2ea44f?style=for-the-badge&logo=googlechrome&logoColor=white)](https://sofiachat.com)
